  ...
  return (
    <div>
      <div className="bg-green-700 h-44 w-full rounded-lg pt-9">
        <img className="rounded-lg w-11/12 h-48 md:w-4/5 md:h-60 object-cover m-auto" src={imageSrc} alt="" />
      </div>
      <div className="mt-12 md:mt-28 flex justify-center items-center flex-col gap-3 p-4">
